...
public class EmulatorDetector extends ReactContextBaseJavaModule {
    ...
    EmulatorDetector(ReactApplicationContext context) {
        super(context);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (checkAdvanced())
                        promise.resolve(true);
                    if (checkPackageName(reactContext))
                        promise.resolve(true);
...
// public void run() {
// try {
// promise.resolve(Build.FINGERPRINT.startsWith("generic")
